...
2. Navigate to Plugins > Add New > Uploads.
3. Select 'numerology-calculator.zip' and upload it. Or,
4. Extract the zip file and place in the plugins directory (usually 'wp-content/plugins/').
5. Activate the plugin through the 'Plugins' screen.
6. Add the shortcode ['numerology-calculator'] to any post or page.
